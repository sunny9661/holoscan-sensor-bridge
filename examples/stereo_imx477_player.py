...
def main():
    ...
    camera_left.set_analog_gain_msb_reg(0x2)  # analog MSB 2 bits
    camera_left.set_analog_gain_lsb_reg(0xFF)  # analog LSB 8 bits

    # IMX477 Analog gain settings functions. msb_reg contains MSB 2 bits and lsb_reg contains LSB 8 bits. Users are free to experiment with the register values.
    camera_right.set_analog_gain_msb_reg(0x2)  # analog MSB 2 bits
    camera_right.set_analog_gain_lsb_reg(0xFF)  # analog LSB 8 bits
