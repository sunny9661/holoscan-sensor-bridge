...
def main():
    ...
    camera_left.set_register(0x204, 0x2)  # analog MSB 2 bits
    camera_left.set_register(0x205, 0xFF)  # analog LSB 8 bits

    # IMX477 Analog gain settings registers. register 204 contains MSB 2 bits and register 205 contains LSB 8 bits. Users are free to experiment with the register values
    camera_right.set_register(0x204, 0x2)  # analog MSB 2 bits
    camera_right.set_register(0x205, 0xFF)  # analog LSB 8 bits
